...
// Version_getVersionForDimensions Deduces version information from Data Matrix dimensions.
//
...
//
func Version_getVersionForDimensions(numRows, numColumns int) (*Version, error) {
