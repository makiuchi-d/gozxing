...
var versions = []*Version{
	...
	NewVersion(33, 12, 48, 10, 22,
		&ECBlocks{23, []ECB{{1, 32}}}),
	NewVersion(34, 12, 64, 10, 14,
		&ECBlocks{27, []ECB{{1, 43}}}),
	NewVersion(35, 16, 64, 14, 14,
		&ECBlocks{36, []ECB{{1, 62}}}),
	NewVersion(36, 24, 32, 22, 14,
		&ECBlocks{28, []ECB{{1, 49}}}),
	NewVersion(37, 24, 36, 22, 16,
		&ECBlocks{33, []ECB{{1, 55}}}),
	NewVersion(38, 24, 48, 22, 22,
		&ECBlocks{41, []ECB{{1, 80}}}),
	NewVersion(39, 24, 64, 22, 14,
		&ECBlocks{46, []ECB{{1, 108}}}),
	NewVersion(40, 26, 32, 24, 14,
		&ECBlocks{32, []ECB{{1, 52}}}),
	NewVersion(41, 26, 40, 24, 18,
		&ECBlocks{38, []ECB{{1, 70}}}),
	NewVersion(42, 26, 48, 24, 22,
		&ECBlocks{42, []ECB{{1, 90}}}),
	NewVersion(43, 26, 64, 24, 14,
